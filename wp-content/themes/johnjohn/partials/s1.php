    ...
    <div class="row">
      ...
      <div class="col-md-3 col-xs-2 -heroheight">
        <div class="leftwrap">
          ...
          <button class="play-button -animated" id="hero-play" data-scroll-speed="5" data-animation="animation-fade-in-down"></button>
      ...
      <div class="col-md-9 col-xs-10 _unpad-l">
        ...
        <a href="https://www.instagram.com/john_john_florence/?hl=en" target="_blank" class="handle -absolute animation css-ease" data-scroll-speed="2" data-animation="animation-fade-in-left" data-delay="300">@john_john_florence</a>

        <div class="ss-ease" data-scroll-speed="8">
